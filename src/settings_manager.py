...
AVAILABLE_SHEETS = [
    "Default", "Sandbox", "GEO", "TENNIS", "MANAGER", "EQUIP", "TRAINING",
    "MATCH", "STAFF", "INBOX", "PLAYER", "ACADEMY", "SCENARIOS", "TUTO",
    "FC", "MEDIA", "LD_INBOX", "LD_RADIO", "UI", "WORLD", "LD_BRIEFING",
    "LD_OBJ_CA", "LD_OBJ_PLY", "LD_RPT_TRAIN", "LD_TALK", "LD_ADVICES",
    "MP_UI", "MP_ATT", "MP_NEWS", "MP_SKILLS", "MP_TUTO"
]
...
class SettingsManager:
    ...
    def run_setup_wizard(self) -> None:
        ...
        target_col = Prompt.ask(
            "[bold]Target Column Name[/bold] (in Excel)",
            default="English",
            show_default=True
        )
